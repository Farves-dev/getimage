...
var require_lodash = __commonJS({
  "node_modules/lodash.clamp/index.js"(exports, module) {
    ...
    function clamp8(number, lower, upper) {
      if (upper === void 0) {
        upper = lower;
        lower = void 0;
      }
...
function mouseHandler(scrollbar) {
  ...
  function calcMomentum2(direction, clickPosition) {
    ...
    if (direction === Direction.X) {
      ...
      return (0, import_lodash6.default)(clickPosition / totalWidth * size.content.width, 0, limit.x) - offset.x;
    }
    if (direction === Direction.Y) {
      var totalHeight = size.container.height + (yAxis.thumb.realSize - yAxis.thumb.displaySize);
      return (0, import_lodash6.default)(clickPosition / totalHeight * size.content.height, 0, limit.y) - offset.y;
    }
    return 0;
  }
...
// dep:smooth-scrollbar
var smooth_scrollbar_default2 = smooth_scrollbar_default;
export {
  ScrollbarPlugin,
  smooth_scrollbar_default2 as default
};
/*! *****************************************************************************
